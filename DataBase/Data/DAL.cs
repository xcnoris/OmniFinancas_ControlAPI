...
namespace DataBase.Data
{
    public class DAL<T> : IDisposable where T : class
    {
        ...
        public async Task<IEnumerable<T>> ListarAsync()
        {
            ...
            {
                GeracaoLog.RegistrarLog("Conexao", Exception.Message);
        ...
        public async Task AdicionarAsync(T objeto)
        {
            ...
            catch (Exception ex)
            {
                ...
                GeracaoLog.RegistrarLog("Conexao", ex.Message);
        ...
        public async Task DeletarPorCondicaoAsync(Expression<Func<T, bool>> filtro)
        {
            try
            {
                ...
                {
                    GeracaoLog.RegistrarLog("Conexao", "Nenhum objeto encontrado para deletar.");
                }
            }
            catch (Exception Exception)
            {
