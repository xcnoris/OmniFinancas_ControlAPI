...
namespace DataBase.Migrations
{
    ...
    [Migration("20250422003943_AddClunTipoUserINTBUserlogin")]
    partial class AddClunTipoUserINTBUserlogin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modelos.EF.Login.UserLoginModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("UsuarioRevendaId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("UsuarioRevendaId");
            ...
            modelBuilder.Entity("Modelos.EF.Login.UserLoginModel", b =>
                {
                    b.HasOne("Modelos.EF.Revenda.UsuariosRevendaModel", "UsuarioRevenda")
                        .WithMany()
                        .HasForeignKey("UsuarioRevendaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UsuarioRevenda");
                });
